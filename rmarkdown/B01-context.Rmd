...
This dataset provides a prediction of total PM~2.5~ concentration and flags to estimate the bushfire-specific portion, covering Australia from January 2001 to June 2020 with an update for January 2020 to December 2023. In conjunction with health data, it may be used to elucidate the health burden and impacts due to bushfire smoke PM~2.5~ and plan for the mitigation of health effects in the future, particularly with increasing threat of unusually severe bushfire events.
