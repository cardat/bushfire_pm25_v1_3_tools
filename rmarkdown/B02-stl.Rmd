...
```{r method-stl-cumulative, dev = 'png', message = F, fig.height = 4, fig.cap = "Cumulative addition of STL components to total PM2.5 concentration for pixel in Darwin (NT) for the year 2015."}
library(gganimate)
plt_animate <- 
