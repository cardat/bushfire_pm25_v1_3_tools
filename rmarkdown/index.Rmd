...
caption_raster <- sprintf('Raster map of total PM2.5 (ug/m3) for Australia on %s. %s is marked with a white diamond, corresponding to the location of the STL decomposition shown below.', dd, place_name)
