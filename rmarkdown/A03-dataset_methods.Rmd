...
For each pixel, a series of binary flags to aid identification of PM~2.5~ source were extracted from a varity of satellite data and weather grids.


A series of binary flags (relating to dust, temperature and active fires) were extracted from satellite data and weather grids. 
